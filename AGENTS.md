...
**Exception for this project:** This project uses React + TailwindCSS + Tauri v2 (not WASM/Dioxus), so the Pico CSS rule does not apply. React components are used as-is.
- For data processing:
